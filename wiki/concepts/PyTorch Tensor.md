...
- [[2026-04-12-deep-learning-with-pytorch]]: Core data structure in Deep Learning with PyTorch
- [[2026-04-29-hands-on-ml-python]]: Used for representing training data in Hands-on ML with Python
